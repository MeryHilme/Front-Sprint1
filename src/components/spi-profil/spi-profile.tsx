            ...
            <div class="columns">
                <div class="column is-10">
                  <table class="table is-hoverable is-fullwidth is-striped">
                    <th><font color="red">Actions</font></th>
                    <tbody>
                      <tr>
                        <td ><i class="fas fa-graduation-cap"></i></td>
                        <td>Formations</td>
                        <td><a class="button is-small is-primary" href="/list"><i class="fas fa-eye"></i>&nbsp;Consulter</a></td>
                        <td><a class="button is-small is-info" href="/ajout"><i class="fas fa-plus"></i>&nbsp;Ajouter</a></td>
                      </tr>
                      <tr>
